...
var c_cppHighlightRules = function() {
    ...
    var storageType = (
        ...
        "class|wchar_t|template|char16_t|char32_t|macro"
    );
    ...
    var builtinConstants = (
        "NULL|true|false|TRUE|FALSE|nullptr|var|nil"
    );
    ...
    this.$rules = {
        "start" : [
            ...
            DocCommentHighlightRules.getStartRule("doc-start"),
            {
                ...
                regex : "#\\s*(?:include|import|pragma|line|define|undef|macro)\\b",
                next  : "directive"
            }, {
                token : "keyword", // special case pre-compiler directive
                regex : "#\\s*(?:endif|if|ifdef|else|elif|ifndef|fi)\\b"
            }, {
